...
import 'package:w_health/wearOS_module/wear_services/wear_report.dart';

class SOSReportService {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<SosReport> addStatus(
      String status, String Name_Surname, GeoPoint location) async {
    //GeoPoint location
